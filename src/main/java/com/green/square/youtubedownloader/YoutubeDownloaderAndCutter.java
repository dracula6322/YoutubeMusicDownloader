...
//        command.add("wait");
        ...
        ArrayList<List<String>> result = executeFunctionAndGetStringOutput(command.toArray(new String[0]), "",
                new String[]{},
...
//        + id;
        ...
        command.add("-o");
        command.add("\"" + saveFolder + File.separator + "original_%(id)s.%(ext)s\"");
        ...
        ArrayList<List<String>> outputResult = executeFunctionAndGetStringOutput(command.toArray(new String[0]),
                "",
                new String[]{},
                inputThread, errorThread);
    ...
    private String downloadJsonInMemory(String pathToYoutubedl, String id,
        ...
        if (SystemUtils.IS_OS_LINUX) {
            //commandArray.add(" & wait");
            //commandPath = commandPath + ;
        }

        System.out.println("commandPath = " + commandArray.toString());
        ArrayList<List<String>> result = executeFunctionAndGetStringOutput(commandArray.toArray(new String[0]), "",
                new String[]{}, inputThread,
                errorThread);
        System.out.println("result = " + result);
    ...
    private ArrayList<String> cutFileByPairs(String ffmpegPath, File audioFile, ArrayList<Pair<String, String>> pairs,
        ...
        for (int i = 0; i < pairs.size(); i++) {
            ...
            if (SystemUtils.IS_OS_LINUX) {
                ...
                outputFilePath = "" + rootDirPath + fileName + ".mp4" + "";
            } else {
            ...
            ArrayList<List<String>> executeResult = executeFunctionAndGetStringOutput(
                    commandArray.toArray(new String[0]), rootDirPath, new String[]{}, inputThread, errorThread);
