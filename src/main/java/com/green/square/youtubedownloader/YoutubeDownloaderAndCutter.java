...
//    }
    ...
    public ArrayList<List<String>> executeFunctionAndGetStringOutputSyncWithRootDir(String stringCommand, String rootDir,
    ...
    public ArrayList<List<String>> executeFunctionAndGetStringOutputSyncWithRootDirWithEnv(String stringCommand,
    ...
    private File downloadFile(String pathToYoutubedl, String id, String saveFolder, String name,
        ...
        ArrayList<List<String>> outputResult = executeFunctionAndGetStringOutputSyncWithRootDir(commandPath, "",
                inputThread, errorThread);
    ...
    private String downloadJsonInMemory(String pathToYoutubedl, String id,
                                        ExecutorService inputThread, ExecutorService errorThread) {
        ...
        System.out.println("commandPath = " + commandPath);
        ArrayList<List<String>> result = executeFunctionAndGetStringOutputSyncWithRootDir(commandPath, "", inputThread,
                errorThread);
        //System.out.println("result = " + result);
    ...
    private ArrayList<String> cutFileByPairs(String ffmpegPath, File audioFile, ArrayList<Pair<String, String>> pairs,
        ...
        for (int i = 0; i < pairs.size(); i++) {
            ...
            commandPath += " " + outputFilePath + " ";
            commandArray.add("" + commandPath + "");

          System.out.println("commandArray = " + commandArray);
          //String[] commandPathArray = {commandPath};

            System.out.println("commandPath = " + commandPath);

            ArrayList<List<String>> executeResult = executeFunctionAndGetStringOutputSyncWithRootDirWithEnv(commandArray.toArray(new String[0]), rootDirPath, new String[]{},
                    inputThread, errorThread);
