...
//    }
    ...
    private String getIdFromLink(String pathToYoutubedl, String link, ExecutorService inputThread,
        ...
        if (SystemUtils.IS_OS_LINUX) {
            commandPath = commandPath + " & wait";
        }


        ArrayList<List<String>> result = executeFunctionAndGetStringOutput(commandPath, "",
    ...
    private File downloadFile(String pathToYoutubedl, String id, String saveFolder, String name,
        ...
        ArrayList<List<String>> outputResult = executeFunctionAndGetStringOutput(commandPath, "", new String[]{},
                inputThread, errorThread);
    ...
    private String downloadJsonInMemory(String pathToYoutubedl, String id,
        ...
        System.out.println("commandPath = " + commandPath);
        ArrayList<List<String>> result = executeFunctionAndGetStringOutput(commandPath, "", new String[]{}, inputThread,
                errorThread);
        //System.out.println("result = " + result);
    ...
    private ArrayList<String> cutFileByPairs(String ffmpegPath, File audioFile, ArrayList<Pair<String, String>> pairs,
        ...
        for (int i = 0; i < pairs.size(); i++) {
            ...
            ArrayList<List<String>> executeResult = executeFunctionAndGetStringOutput(
                    commandPath, rootDirPath, new String[]{}, inputThread, errorThread);
