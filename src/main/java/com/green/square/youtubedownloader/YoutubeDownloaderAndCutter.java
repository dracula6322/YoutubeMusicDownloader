...
//      }
            ...
            if (downloadedFileIsExists) {
                ...
                downloadedAudioFile = downloadFile(pathToYoutubedl, id, pathToYoutubeFolder, name, inputThread,
                        errorThread);
...
//
            try {
                ...
                ArrayList<String> cutFiles = cutFileByPairs(ffmpegPath, downloadedAudioFile, pairs, duration, inputThread,
                        errorThread, pathToYoutubeFolder);
...
//    }
    ...
    private String getIdFromLink(String pathToYoutubedl, String link, ExecutorService inputThread,
        ...
        ArrayList<List<String>> result = executeFunctionAndGetStringOutputWithRoot(command.toArray(new String[0]), "",
                inputThread,
                errorThread);
...
//    }
    ...
    private File downloadFile(String pathToYoutubedl, String id, String saveFolder, String name,
        ...
        if (SystemUtils.IS_OS_LINUX) {
            rootDirPath = "/";
            fileName = saveFolder + "original_%(id)s.%(ext)s";
        } else {
            rootDirPath = "";
            fileName = "\"" + saveFolder + "original_%(id)s.%(ext)s\"";
        }
        ...
        ArrayList<List<String>> outputResult = executeFunctionAndGetStringOutputWithRoot(command.toArray(new String[0]),
                rootDirPath,
    ...
    private String downloadJsonInMemory(String pathToYoutubedl, String id, ExecutorService inputThread,
        ...
        ArrayList<List<String>> result = executeFunctionAndGetStringOutputWithRoot(commandArray.toArray(new String[0]), "",
                inputThread,
                errorThread);
        System.out.println("result = " + result);
