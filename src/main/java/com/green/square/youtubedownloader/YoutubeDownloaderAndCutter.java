...
//    }
    ...
    private ArrayList<List<String>> executeFunctionAndGetStringOutputSyncWithRootDir(String stringCommand, String rootDir,
        ...
        try {
            Runtime runtime = Runtime.getRuntime();
            Process command = runtime.exec(stringCommand, new String[]{}, new File(rootDir));
    ...
    private ArrayList<String> cutFileByPairs(String ffmpegPath, File audioFile, ArrayList<Pair<String, String>> pairs,
        ...
        for (int i = 0; i < pairs.size(); i++) {
            ...
            String audioOutName = (audioFile.getParent() + File.separator + fileName) + ".webm";

            String commandPath = "/usr/bin/ffmpeg "
                    + " -loglevel debug "
                    + " -y "
            ...
            ArrayList<List<String>> executeResult = executeFunctionAndGetStringOutputSyncWithRootDir(commandPath, "/home/andrey/youtubeNew/VnQ52zzyWMY/", inputThread,
                    errorThread);
